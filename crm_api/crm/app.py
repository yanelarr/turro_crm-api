...
from crm.routes.stock.classification import classification_route
from crm.routes.stock.mark import mark_route
...
app.include_router(classification_route, prefix="/api")
app.include_router(mark_route, prefix="/api")